...
var KTLogin = function () {
  ...
  var _handleSignInForm = function _handleSignInForm() {
    ...
    $('#password').on('keypress', function (e) {
      if (e.which == 13 && !e.shiftKey) $('#kt_login_signin_submit').click();
    });
    $('#kt_login_signin_submit').on('click', function (e) {
      ...
      validation.validate().then(function (status) {
        if (status == 'Valid') {
          ...
          var form_data = new FormData($('#kt_login_signin_form')[0]);
          ...
          if (!((window.innerWidth > 0 ? window.innerWidth : screen.width) < 992)) KTUtil.scrollTop();
        }
      });
    });
  ...
  var countdown = function countdown(timer) {
